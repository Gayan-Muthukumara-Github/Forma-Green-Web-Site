      ...
      <div class="container">
        <div class="row mb-3">
          <div class="col-md-6">
            <div class="block-16">
              <figure>
                <img src="images/img2.jpg" alt="Image placeholder" class="img-fluid rounded">
              </figure>
            </div>
          </div>
          ...
          <div class="col-md-5">
            ...
            <p>Forma-Green reintroduces plants in schools,
                  universities, training schools, training centers, ... This association allows each member to receive
                  discounts in partner shops against a participation allowing the installation and maintenance of green
                  spaces.</p>
